...
"""
# For local development with static files, set DEBUG=True
# For production or testing full auth flow, set DEBUG=False and use --insecure flag
DEBUG = True
# DEBUG = False
...
# Additional directories for static files finder
STATICFILES_DIRS = [
